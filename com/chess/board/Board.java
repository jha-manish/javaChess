...
public class Board {
    ...
    public Tiles getTile(final int tileCordinate){
        return gameBoard.get(tileCordinate);
    }
    ...
    //This function creates pieces and sets them on to the board on their respective places(offsets)
